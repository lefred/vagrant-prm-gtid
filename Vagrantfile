...
Vagrant.configure("2") do |config|
  config.vm.define :percona1 do |percona1_config|
	...
	percona1_config.vm.provider :virtualbox do |percona1_vb|
    		percona1_vb.customize ["modifyvm", :id, "--cpuexecutioncap", "50", "--memory", "1024", "--ioapic", "on"]
  	end
	percona1_config.vm.network :private_network, ip: "192.168.80.2"
  ...
  config.vm.define :percona2 do |percona2_config|
	...
	percona2_config.vm.network :private_network, ip: "192.168.80.3"
...
#		percona3_vb.gui = true
  	end
	percona3_config.vm.network :private_network, ip:  "192.168.80.4"
